# This dockerfile uses extends image https://hub.docker.com/woodpecker-kit/woodpecker-gitea-cc-release
# VERSION 1
...
ARG GO_ENV_PACKAGE_NAME=github.com/woodpecker-kit/woodpecker-gitea-cc-release
ARG GO_ENV_ROOT_BUILD_BIN_NAME=woodpecker-gitea-cc-release
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/woodpecker-gitea-cc-release/main.go
...
ENTRYPOINT [ "/app/woodpecker-gitea-cc-release" ]
# CMD ["/app/woodpecker-gitea-cc-release", "--help"]