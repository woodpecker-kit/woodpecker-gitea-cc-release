...
import (
	...
	"github.com/woodpecker-kit/woodpecker-gitea-cc-release"
	"github.com/woodpecker-kit/woodpecker-gitea-cc-release/cmd/cli"
...
func main() {
	...
	pkg_kit.InitPkgJsonContent(woodpecker_gitea_cc_release.PackageJson)
